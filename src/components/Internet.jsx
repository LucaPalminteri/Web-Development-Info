        ...
        <div className="main">
            ...
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="https://kamranahmed.info/blog/2016/08/13/http-in-depth/">Journey to HTTP/2</a></li>
                ...
                <ul>
                    ...
                    <li><a href="https://www.browserstack.com/guide/browser-rendering-engine">Role of Rendering Engine in Browsers</a></li>
                ...
                <ul>
                    ...
                    <li><a href="https://www.youtube.com/watch?v=7lxgpKh_fRY">DNS Records</a></li>
                    <li><a href="https://www.youtube.com/watch?v=e48AyJOA9W8">When to add glue records to DNS settings</a></li>
                </ul>
                <li>What is Domain Name?</li>
                <ul>
                    <li><a href="https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_is_a_domain_name">What is a Domain Name?</a></li>
                ...
                <ul>
                    ...
                    <li><a href="https://www.youtube.com/watch?v=Kx_1NYYJS7Q">Where to Host a Fullstack Project on a Budget</a></li>
                </ul>
            </ul>
        </div>
    )
